 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.TypeDefImpl#getMappedType <em>Mapped Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypeDefImpl extends TypeImpl implements TypeDef
{
  ...
  {
    return MyDslPackage.Literals.TYPE_DEF;
  }
  ...
  public NotificationChain basicSetMappedType(JAVAID newMappedType, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.TYPE_DEF__MAPPED_TYPE, oldMappedType, newMappedType);
  ...
  public void setMappedType(JAVAID newMappedType)
  {
    if (newMappedType != mappedType)
    {
      ...
      if (mappedType != null)
        msgs = ((InternalEObject)mappedType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.TYPE_DEF__MAPPED_TYPE, null, msgs);
      if (newMappedType != null)
        msgs = ((InternalEObject)newMappedType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.TYPE_DEF__MAPPED_TYPE, null, msgs);
      msgs = basicSetMappedType(newMappedType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.TYPE_DEF__MAPPED_TYPE, newMappedType, newMappedType));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.TYPE_DEF__MAPPED_TYPE:
